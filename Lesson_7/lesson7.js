 ...
 */
function notSnakeUnit(unit) { //проверка, что змейка не попала сама в себя в новой ячейке
    var check = true;
    ...
    //проверка, не врезалась ли в препятствие
...
function createStones() {
    ...
    while (!stoneCreated && gameIsRunning) {
        ...
        setTimeout(function () {
            stone_cell.classList.remove('stone-unit')
        }, 10000);
    }
